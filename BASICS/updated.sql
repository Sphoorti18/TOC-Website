CREATE TABLE ComputationalModels (
    MachineType VARCHAR(100),
    TransitionFunctionNotation VARCHAR(255),
    Description TEXT
);

INSERT INTO ComputationalModels (MachineType, TransitionFunctionNotation, Description) VALUES
